...
data <- read.csv("result/data_one_hot.csv", stringsAsFactors = F)
predictor_var_file_list <- c("result/predictor_var.csv")
outDir <- "result/stack"
var_to_predict <- "suicidality_T4"
rNCVdir <- "rNCV"
rdata_prefix <-"combine"
targetType <- "binary"
nRep <- 5
nFolds.outer <- 5
```
